"""
Django settings for odd_glade_39475 project.
...
ROOT_URLCONF = 'odd_glade_39475.urls'
...
WSGI_APPLICATION = 'odd_glade_39475.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "odd_glade_39475 API",
    "DESCRIPTION": "API documentation for odd_glade_39475 App",
    "VERSION": "v1",
}
